 ...
 * @LastEditTime: 2024-11-03 18:40:07
    ...
    <div>
      ...
      <div className="flex justify-center width-100 buy-box">
        <div className="flex justify-end items-center  buy-bar">
            ...
            {guideInfo.owner === address ?  <Button className="m-r-24"  variant="outlined" onClick={back}>已拥有</Button> : <Button className="m-r-24" disabled={guideInfo.sales_status === 0}  type="primary"  onClick={()=> buy(guideInfo.id)}> {guideInfo.sales_status === 0 ? "待售" : "购买"}</Button>   }
        </div>
      </div>
